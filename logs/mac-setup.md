...
```bash
Identity added: /Users/your-user/.ssh/id_ed25519 (your-email)
```
...
公開用の学習ログでは、GitHubユーザー名・メールアドレス・ローカルユーザー名などの個人情報はサンプル値に置き換えている。
...
公開用の学習ログでは、実際のメールアドレスではなく `your-email` のようなサンプル値に置き換えて記載している。
